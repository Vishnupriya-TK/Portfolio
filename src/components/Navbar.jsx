  ...
  return (
    <nav className="fixed top-0 w-full z-50 backdrop-blur bg-black/90 border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-blue-800 text-white font-bold flex items-center justify-center">
            VP
          </div>
          <span className="font-semibold text-lg text-gray-200">Portfolio</span>
        </button>
      ...
      {open && (
        <div className="md:hidden px-6 pb-4 flex flex-col gap-2">
          ...
          <NavLink onClick={() => setOpen(false)} to="/work" className={linkClass}>Work</NavLink>
